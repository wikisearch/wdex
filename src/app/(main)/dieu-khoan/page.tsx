...
export const metadata: Metadata = {
  title: "Điều khoản Dịch vụ - wdex",
  description: "Điều khoản và điều kiện sử dụng dịch vụ wdex",
          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              ...
              <p className="leading-relaxed text-gray-700">
                Chào mừng bạn đến với wdex. Bằng việc truy cập và sử dụng dịch
                vụ của chúng tôi, bạn đồng ý tuân thủ các điều khoản và điều
                kiện được nêu dưới đây. Nếu bạn không đồng ý với bất kỳ điều
            ...
            <section className="mb-8">
              ...
              <div className="mb-4 border-l-4 border-blue-400 bg-blue-50 p-4">
                <p className="font-medium text-blue-800">
                  wdex tuân thủ đầy đủ Chính sách Sử dụng của MangaDex
                </p>
              </div>
              <p className="mb-4 leading-relaxed text-gray-700">
                wdex sử dụng proxy để truy xuất dữ liệu từ MangaDex API một cách
                hợp pháp và tuân thủ các quy định của MangaDex. Chúng tôi cam
                kết:
              </p>
            ...
            <section className="mb-8">
              ...
              <div className="mb-4 border-l-4 border-yellow-400 bg-yellow-50 p-4">
                <p className="font-medium text-yellow-800">
                  wdex không chịu trách nhiệm về nội dung từ MangaDex
                </p>
              </div>
              <p className="mb-4 leading-relaxed text-gray-700">
                wdex chỉ đóng vai trò là cầu nối giữa người dùng và nội dung
                được phân phối bởi MangaDex. Chúng tôi:
              </p>
              <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-700">
                <li>
            ...
            <div className="mt-8 border-t pt-6">
              <p className="text-center text-sm text-gray-500">
                wdex - Nền tảng đọc truyện tranh thân thiện với độc giả Việt Nam
              </p>
            </div>
          </div>
        </div>
