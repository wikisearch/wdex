          ...
          <div className="mb-2 grid grid-cols-1 gap-2 md:grid-cols-3 xl:grid-cols-4">
            ...
            <div>
              ...
              <div className="relative">
                <select
                  className="block w-full appearance-none items-center justify-between rounded-lg border border-border/30 bg-background p-2.5 pr-10 capitalize leading-[21px] text-foreground shadow-soft transition-all duration-200 focus:border-accent/50 focus:shadow-soft-md focus:ring-2 focus:ring-accent/20"
                  {...register("orderType")}
                >
