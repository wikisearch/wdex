...
const ALERTS = [
  <Alert
    ...
    title=" wdex đang trong quá trình phát triển và có nhiều lỗi phát sinh, trong quá trình trải nghiệm
  ...
  <Alert
    ...
    title=" Giao diện wdex là một dự án mã nguồn mở, nếu không ưng ý giao diện, bạn hoàn toàn có thể đóng góp phát triển giao diện!"
    action={
      <Link
        className="no-underline hover:no-underline"
  ...
  <Alert
    ...
    title=" wdex lấy dữ liệu từ MangaDex, hoàn toàn miễn phí, không có quảng cáo, nếu bạn thích wdex, hãy kêu gọi các nhóm dịch đăng truyện tại MangaDex!"
    action={
      <Link
        className="no-underline hover:no-underline"
  ...
  <Alert
    ...
    title=" Bạn có thể đồng bộ truyện theo dõi từ nhiều nguồn CManga (NetTruyen, TruyenQQ), MangaDex, CuuTruyen sang wdex"
    action={
      <Link
        className="no-underline hover:no-underline"
